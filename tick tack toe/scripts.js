class Game {
  ...
  begin() {
    ...
    game.addEventListener("click", event => {
      ...
      if (target.className === "block active") {
  ...
  printScore() {
    ...
    human_score.textContent = `Пользователь выиграл ${this.human.wins} раз(а)`;
    ai_score.textContent = `Компьютер выиграл ${this.ai.wins} раз(а)`;
